  ...
  return (
    <li className="relative bg-white flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-2">
      <Link className="contents" to={`/category/${listing.type}/${id}`}>
        <img
          className="h-64 w-full object-cover hover:scale-105 transition-scale duration-200 ease-in"
          loading="lazy"
        ...
        <div className="w-full p-[10px]">
          ...
          <p className="text-[#457b9d] mt-2 font-semibold flex">
            <MdCurrencyRupee className="mt-1.5 text-sm" />
            {listing.offer
      ...
      {onEdit && (
        <MdEdit
          className="absolute bottom-1.5 right-7 text-xl cursor-pointer text-green-600"
